...
3. Add a hamburger icon to the header navigation that displays at the same min-width as your layout fix. Here are some steps for the hamburger dropdown:
    ...
    - select the containing list element and give it a background using this [hamburger](http://assets.aaonline.io/fullstack/html-css/micro-projects/positioning_media_queries/solution/assets/images/hamburger.png) file.
